      ...
      <Container>
        <div className="welcome">
          ...
          <div className="welcome-content">
            ...
            {<br/>}{<br/>}Как вы уже знаете, начиная с этого года лауреатов премии определяют члены Академии, в составе которой более 100 выдающихся деятелей и профессионалов, работающих в сфере музыкального театра (<a href="https://musicalheart.ru/persona/akademiki/"><u>Академики</u></a>).
